...
const Cartcount = ({onCartToggle}) => {
  return (
   <>
   <div className=" bg-white h-11 flex items-center justify-between sticky px-3 top-0 left-0 right-0 w-full">
    <div className="flex items-center gap-3 ">
        ...
        <h1 className='text-base font-medium text-slate-900 '>Your Cart
          <span className='bg-theme-cart rounded px-1 py-0.5 ml-1 text-slate-100 font-normal text-xs'>(Items)</span> </h1>
        </div>
    </div>
